...
const SidebarContent = ({ onClose, ...rest }: SidebarProps) => {
  ...
  const tenantRoles = ['community-owner', 'community-admin', 'community-member', 'identity-verifier'];
  ...
  const MockedLinkItems: Array<NavItemPropsInterface> = [
    ...
    { name: 'Follows', path: '/follows', entity: 'follow', service: AccessServiceEnum.PROJECT, icon: FiBox },
    {
      name: 'Identity Cards',
      path: '/identity-cards',
    ...
    { name: 'Posts', path: '/posts', entity: 'post', service: AccessServiceEnum.PROJECT, icon: FiBox },
